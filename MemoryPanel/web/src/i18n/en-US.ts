...
export const enUS = {
  ...
  // ===== Dispatch =====
  'dispatch.title': 'Task Dispatch',
  'dispatch.desc': 'Cross-agent task inbox: send, claim, and write back results. One FIFO queue per agentId.',
  'dispatch.allStatuses': 'All statuses',
  'dispatch.refresh': 'Refresh',
  'dispatch.claimNext': 'Claim next',
  'dispatch.sendTask': 'Send task',
  'dispatch.claimedPrefix': 'Claimed',
  'dispatch.inboxEmpty': 'Inbox empty — no queued tasks.',
  'dispatch.empty': 'No tasks in this queue.',
  'dispatch.colType': 'Type',
  'dispatch.colPayload': 'Payload',
  'dispatch.colFrom': 'From',
  'dispatch.colResult': 'Result',
  'dispatch.colStatus': 'Status',
  'dispatch.colUpdated': 'Updated',
  'dispatch.claimedLabel': 'CLAIMED',
  'dispatch.resultPlaceholder': 'result...',
  'dispatch.markDone': 'Mark done',
  'dispatch.markFailed': 'Fail',
  'dispatch.done': 'done',
  'dispatch.failed': 'failed',
  'dispatch.sentPrefix': 'Sent:',
  'dispatch.sendTitle': 'Send task to agent',
  'dispatch.fieldFrom': 'From agent',
  'dispatch.fieldTo': 'Target agent',
  'dispatch.fieldType': 'Task type',
  'dispatch.fieldPayload': 'Payload',
  'menu.dispatch': 'Agent Console',
  'menu.desc.dispatch': 'Cross-agent handoff: send / claim / result write-back',

  'dispatch.agentAssets': 'Agent asset overview',
  'dispatch.noAgents': 'No agents registered in this team yet. Create one in Agents management.',
  'dispatch.assetWiki': 'Wiki files',
  'dispatch.assetMemory': 'Memories',
  'dispatch.assetSkills': 'Skills',
  'dispatch.assetCode': 'Code graphs',
  'dispatch.queueLabel': 'Queue',
  'dispatch.queued': 'queued',
  'dispatch.running': 'running',
  'dispatch.noQueue': 'no dispatch queue yet',
  'dispatch.taskStatus': 'Task status (initiated / settled)',
  'dispatch.pickAgent': 'Pick an agent to view queue...',
  'dispatch.pickAgentHint': 'Select an agent to view its task status.',
  'dispatch.colFlow': 'From → To',
  'dispatch.apiHint': 'Agents exchange tasks via POST /api/v1/dispatch/send|claim|update; this page is read-only.',
};
